...
namespace SlidesQuickstart
{
    class Program
    {
        ...
        static string[] Scopes = { SlidesService.Scope.Presentations, SlidesService.Scope.Drive };
        ...
        static void Main(string[] args)
        {
            ...
            Presentation createdPresentation = request.Execute();
            Console.WriteLine("Presentation {0} found", createdPresentation.Title);
        }
    }
}
